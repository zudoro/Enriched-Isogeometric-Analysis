...
SUBROUTINE PLOTGM()
	...
	REAL*8 :: NURBS_SUM(2)
	INTEGER :: I, J, II, JJ, KK, NI, NJ, NM, PATCH, IGA_PATCH, EGM_PATCH
	...
	OPEN(1, FILE = './data/zero_bdndx')
	DO J = 1, NUM_PATCH
		DO I=1, ZERO_BDNDX(J,1)%LC_NUM
			WRITE(1,*) J, ZERO_BDNDX(J,I)%LC_NDX(:), ZERO_BDNDX(J,I)%LC_NUM, ZERO_BDNDX(J,I)%GL_NDX
		ENDDO
	ENDDO
	CLOSE(1)
