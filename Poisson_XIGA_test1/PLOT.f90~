...
! 			PRINT*, 'f2f1-',I,J
	...
	OPEN(1, FILE = './data/FtoG_line_R')
	DO I = 2, 100
		TSPT%Y = 1.D0*(I-1)/100.D0
		TSPT%X = 1.D0
		PHY_PT = GET_PHY_PT(TSPT, 2)
		TSPT = GET_REF_PT(PHY_PT,1,'R')
! 			PRINT*, 'f2f1-',I,J
		WRITE(1,*) TSPT
	ENDDO
	CLOSE(1)

	OPEN(1, FILE = './data/FtoG_line_L')
	DO I = 2, 100
		TSPT%Y = 1.D0*(I-1)/100.D0
		TSPT%X = 0.D0
		PHY_PT = GET_PHY_PT(TSPT, 2)
		TSPT = GET_REF_PT(PHY_PT,1,'L')
! 			PRINT*, 'f2f1-',I,J
		WRITE(1,*) TSPT
	ENDDO
	CLOSE(1)
...
! 			IF (DSQRT(PHY_PT%X**2 + PHY_PT%Y**2).LE.0.55D0) THEN
! 				TSPT = GET_REF_PT(PHY_PT,2)
! ! 			PRINT*, 'f2f1-',I,J
! 				WRITE(1,*) TSPT
! 			ENDIF
