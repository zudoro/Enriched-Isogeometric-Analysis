...
!   GLOBAL PARAMETER
	...
	INTEGER, PARAMETER :: NUM_PATCH = 3

	INTEGER :: IGA_ORDER(2), EXTRA_KNOTS(2)
	...
	TYPE(KNOT_VECTOR), SAVE :: GEO_KVEC(NUM_PATCH,2), IGA_KVEC(NUM_PATCH,2), BASIS_KVEC(NUM_PATCH,2), TS_KVEC(2)
	TYPE(CONTROL_POINTS_2D) :: GEO_CTL(NUM_PATCH), IGA_CTL(NUM_PATCH), TS_CTL
...
!	MATERIAL COEFFICIENTS
	...
	REAL*8, PARAMETER :: Q = -DCOS((0.544483737D0 - 1.D0)*135.D0*DEGREE)/DCOS((0.544483737D0 + 1.D0)*135.D0*DEGREE)
