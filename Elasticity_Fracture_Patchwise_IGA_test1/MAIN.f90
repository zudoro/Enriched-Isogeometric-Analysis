PROGRAM MAIN
  ...
  REAL :: CPTS, CPTE
	...
	PRINT*, '---------------------------------------------------'
	PRINT*, 'Elasticity on L-shaped domain by using Isogeometric Analysis'
	...
	FILENAME = trim('./data/Elasticity_L_shaped_k_ref_RAD_pro') // char_problem // trim('_') // BCTYPE // trim('_') // PLANE_TYPE
